...
PUSHOVER_USER   = 'uzzjhx96wgj6gpcj7chzqtbmyraxvg'
PUSHOVER_APP    = 'axo5jr8ns9eqdz4ji55ebc2utokyfp'
...
class LambdaMonitor:
    ...
    def __init__(self, context, suffix=None):
        ...
        self.pushover = pushover = Client(PUSHOVER_USER, api_token=PUSHOVER_APP)
